...
public class Article extends DataEntity<Article> {
	...
	public Map<String, Object> getHomePageArticle() {
		Map<String, Object> articleMap = Maps.newHashMap();
		articleMap.put("id", this.getId());
		articleMap.put("title", this.getTitle());
		articleMap.put("image", this.getImage());
		articleMap.put("description", this.getDescription());
		articleMap.put("createDate", DateUtils.formatDate(this.getCreateDate()));
		if(DataStorageUtil.USERNOTICE_CATICLE_ID.equals(this.getCategory().getId())) {
			articleMap.put("link", Global.getConfig("noticeDetail") + "?id=" + this.getId());
		} else if(DataStorageUtil.DOCNOTICE_CATICLE_ID.equals(this.getCategory().getId())) {
			articleMap.put("link", Global.getConfig("doctorNoticeDetail") + "?id=" + this.getId());
		} else {
			articleMap.put("link", Global.getConfig("articleDetail") + "?id=" + this.getId());
		}
		return articleMap;
	}
