...
public class WemallOrderService extends CrudService<WemallOrderDao, WemallOrder> {
	 ...
	 */
	@Transactional(readOnly = false)
	public void saveOrderAndUpdateReg(WemallOrder wemallOrder, String regId) {
	 ...
	 */
	@Transactional(readOnly = false)
	public void updateOrderAndUpdateRegStatus(WemallOrder wemallOrder) {
	 ...
	 */
	@Transactional(readOnly = false)
	public void saveOrderAndUpdateCareAppo(WemallOrder wemallOrder, String careAppoId) {
		/*slSysOrder.setIsNewRecord(true);	//标记为插入
		this.save(slSysOrder);
