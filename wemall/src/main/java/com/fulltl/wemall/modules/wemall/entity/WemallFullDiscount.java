 ...
 * @version 2018-01-05
 */
public class WemallFullDiscount extends DataEntity<WemallFullDiscount> {
	
	private static final long serialVersionUID = 1L;
	private String name;		// 满减送活动名称
	private Integer sort;		// 排序
	private Date startDate;		// 开始时间
	private Date endDate;		// 结束时间
	private String label;		// 标签名
	private String discountCond;		// 满减条件
	...
	public WemallFullDiscount() {
		super();
	}

	public WemallFullDiscount(String id){
		super(id);
	}

	@Length(min=1, max=100, message="满减送活动名称长度必须介于 1 和 100 之间")
	...
	@Length(min=1, max=1000, message="满减条件长度必须介于 1 和 1000 之间")
