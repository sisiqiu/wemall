 ...
 */
package com.fulltl.wemall.common.config;
...
import com.fulltl.wemall.common.utils.PropertiesLoader;
...
public class Global {
	 ...
	 * 获取会员根路径
	 */
	public static String getFrontMemberPath() {
	    return getConfig("frontMemberPath");
	}
