...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="emailValidateCode" readonly="true" htmlEscape="false" maxlength="100"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">第三方用户id:</label>
			<div class="controls">
				<form:input path="platformUserId" htmlEscape="false" maxlength="64"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label">系统用户类别：</label>
			<div class="controls">
				<form:checkboxes path="userCategoryList" items="${fns:getDictList('sys_user_category')}" itemLabel="label" itemValue="value" htmlEscape="false" />
			</div>
			<div class="controls">
