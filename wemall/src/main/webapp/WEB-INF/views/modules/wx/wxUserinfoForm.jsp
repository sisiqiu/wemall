...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/wx/wxUserinfo/">微信绑定用户列表</a></li>
		<li class="active"><a href="${ctx}/wx/wxUserinfo/form?id=${wxUserinfo.wxUserId}">微信绑定用户<shiro:hasPermission name="wx:wxUserinfo:edit">${not empty wxUserinfo.wxUserId?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="wx:wxUserinfo:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="wxUserinfo" action="${ctx}/wx/wxUserinfo/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">关注用户ID：</label>
			<div class="controls">
				<form:input path="subscriberId" htmlEscape="false" maxlength="8" class="input-xlarge  digits"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">微信号：</label>
			<div class="controls">
				<form:input path="wxNo" htmlEscape="false" maxlength="50" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
