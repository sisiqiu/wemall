...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/cms/cmsCollection/">个人收藏管理列表</a></li>
		<li class="active"><a href="${ctx}/cms/cmsCollection/form?id=${cmsCollection.id}">个人收藏管理<shiro:hasPermission name="cms:cmsCollection:edit">${not empty cmsCollection.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="cms:cmsCollection:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="cmsCollection" action="${ctx}/cms/cmsCollection/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">细分类别：</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="module" htmlEscape="false" maxlength="30" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">模块数据id：</label>
			<div class="controls">
