...
<body>
	<ul class="nav nav-tabs">
		<li><a id="firstDis" href="${ctx}/wemall/wemallTeamDiscount/">限时拼团活动列表</a></li>
		<li class="active"><a href="${ctx}/wemall/wemallTeamDiscount/form?id=${wemallTeamDiscount.id}">限时拼团活动<shiro:hasPermission name="wemall:wemallTeamDiscount:edit">${not empty wemallTeamDiscount.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="wemall:wemallTeamDiscount:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="wemallTeamDiscount" action="${ctx}/wemall/wemallTeamDiscount/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="startDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
					value="<fmt:formatDate value="${wemallTeamDiscount.startDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="endDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
					value="<fmt:formatDate value="${wemallTeamDiscount.endDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false});"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		...
		<div class="control-group">
			<label class="control-label">团有效时间(小时数)：</label>
			<div class="controls">
				<form:input path="usefulTime" htmlEscape="false" maxlength="6" class="input-xlarge required digits"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">拼团失败人数：</label>
			<div class="controls">
				<form:input path="failUserNum" htmlEscape="false" maxlength="6" class="input-xlarge required digits"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">商品限购数：</label>
			<div class="controls">
				<form:input path="limitItemNum" htmlEscape="false" maxlength="9" class="input-xlarge required digits"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="wemall:wemallTeamDiscount:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
