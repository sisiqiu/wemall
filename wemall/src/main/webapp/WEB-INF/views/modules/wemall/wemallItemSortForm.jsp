...
<body>
	...
	<form:form id="inputForm" modelAttribute="wemallItemSort" action="${ctx}/wemall/wemallItemSort/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">商品类别名：</label>
			<div class="controls">
		...
		<div class="form-actions">
			<shiro:hasPermission name="wemall:wemallItemSort:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
