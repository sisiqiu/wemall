...
public interface EnglishChineseSoap {
     ...
     * @param wordKey
     * @return
     *     returns cn.itcast.mobile.TranslatorResponse.TranslatorResult
     */
    ...
    @RequestWrapper(localName = "Translator", targetNamespace = "http://WebXml.com.cn/", className = "cn.itcast.mobile.Translator")
    @ResponseWrapper(localName = "TranslatorResponse", targetNamespace = "http://WebXml.com.cn/", className = "cn.itcast.mobile.TranslatorResponse")
    public cn.itcast.mobile.TranslatorResponse.TranslatorResult translator(
    ...
    @RequestWrapper(localName = "TranslatorString", targetNamespace = "http://WebXml.com.cn/", className = "cn.itcast.mobile.TranslatorString")
    @ResponseWrapper(localName = "TranslatorStringResponse", targetNamespace = "http://WebXml.com.cn/", className = "cn.itcast.mobile.TranslatorStringResponse")
    ...
    @RequestWrapper(localName = "TranslatorReferString", targetNamespace = "http://WebXml.com.cn/", className = "cn.itcast.mobile.TranslatorReferString")
    @ResponseWrapper(localName = "TranslatorReferStringResponse", targetNamespace = "http://WebXml.com.cn/", className = "cn.itcast.mobile.TranslatorReferStringResponse")
    ...
    @RequestWrapper(localName = "TranslatorSentenceString", targetNamespace = "http://WebXml.com.cn/", className = "cn.itcast.mobile.TranslatorSentenceString")
    @ResponseWrapper(localName = "TranslatorSentenceStringResponse", targetNamespace = "http://WebXml.com.cn/", className = "cn.itcast.mobile.TranslatorSentenceStringResponse")
    ...
    @RequestWrapper(localName = "SuggestWord", targetNamespace = "http://WebXml.com.cn/", className = "cn.itcast.mobile.SuggestWord")
    @ResponseWrapper(localName = "SuggestWordResponse", targetNamespace = "http://WebXml.com.cn/", className = "cn.itcast.mobile.SuggestWordResponse")
    ...
    @RequestWrapper(localName = "GetMp3", targetNamespace = "http://WebXml.com.cn/", className = "cn.itcast.mobile.GetMp3")
    @ResponseWrapper(localName = "GetMp3Response", targetNamespace = "http://WebXml.com.cn/", className = "cn.itcast.mobile.GetMp3Response")
    public byte[] getMp3(
