 ...
 * generated in the cn.myweather package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://ldk.sanlen.com/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://ldk.sanlen.com/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.myweather
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ldk.sanlen.com/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ldk.sanlen.com/", name = "queryWeatherResponse")
